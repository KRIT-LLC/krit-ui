...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'relative flex h-9 w-full items-center gap-1 rounded-lg border border-line-primary bg-[transparent] px-3 py-2 text-sm tracking-[0.1px] truncate leading-5 text-left text-foreground ring-offset-background transition-colors duration-300 ease-in-out data-[placeholder]:text-muted-foreground hover:bg-background-contrast-fade/20 focus:outline-none focus:border-line-focused disabled:cursor-not-allowed disabled:opacity-50 [&>span]:pr-3 [&>span]:truncate [&>span]:mr-auto',
      className,
    )}
    {...props}
  >
