  ...
  theme: {
    ...
    colors: {
      background: {
        ...
        'in-process': 'hsl(var(--krit-badge-background-in-progress))',
        ...
        reopen: 'hsl(var(--krit-background-reopen))',
        'reopen-fade': 'hsl(var(--krit-background-reopen-fade))',
        transparent: 'hsl(var(--krit-background-transparent))',
      ...
      line: {
        ...
        'in-process': 'hsl(var(--krit-badge-line-in-progress))',
      ...
      icon: {
        ...
        'in-process': 'hsl(var(--krit-badge-icon-in-progress))',
